  ...
  <div>
    <div class="searchList">
      <div class="search" @click="toSearchList">
        <img src="./../../../static/img/searchicon.png" alt="">请输入关键字查询相关问题
      </div>
    </div>
      ...
      <ul class="dataList">
        <li v-for="(item,index) in list">
          <div class="title">
            ...
            <img v-if="!item.clicked" src="./../../../static/img/down.png" alt="" class="down" @click="changeState(index)">
            <img v-if="item.clicked" src="./../../../static/img/up.png" alt="" class="down" @click="changeState(index)">
          </div>
          <div class="answer" v-if="item.clicked">答：{{item.answer}}</div>
        </li>
      </ul>
    </mescroll-vue>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toSearchList() {
        this.$router.push({name:'squestion'});
      },
      ...
      upCallback(page) {
        axios.post("/eport-server/gui/data/queryQuestions.do",
          {
            pageNo: page.num, //页码
